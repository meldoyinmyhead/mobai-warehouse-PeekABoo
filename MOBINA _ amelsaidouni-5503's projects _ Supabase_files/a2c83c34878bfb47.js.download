;!function(){try { var e="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof global?global:"undefined"!=typeof window?window:"undefined"!=typeof self?self:{},n=(new e.Error).stack;n&&((e._debugIds|| (e._debugIds={}))[n]="89fd2f1c-345c-885e-50bc-8b3d9af84f57")}catch(e){}}();
(globalThis.TURBOPACK||(globalThis.TURBOPACK=[])).push(["object"==typeof document?document.currentScript:void 0,271332,e=>{"use strict";var t=e.i(478902),s=e.i(389959),r=e.i(843778),a=e.i(837710),o=e.i(253214);let i=(0,s.forwardRef)(({children:e,customFooter:i,description:n,hideFooter:l=!1,alignFooter:u="left",layout:d="horizontal",loading:c=!1,cancelText:m="Cancel",onConfirm:g=()=>{},onCancel:p=()=>{},confirmText:h="Confirm",showCloseButton:f=!0,footerBackground:_,variant:y="success",visible:b=!1,size:S="large",style:v,overlayStyle:E,contentStyle:T,triggerElement:w,header:I,modal:O,defaultOpen:N,...R},P)=>{let[k,$]=s.default.useState(!!b&&b);(0,s.useEffect)(()=>{$(b)},[b]);let A=i||(0,t.jsxs)("div",{className:"flex w-full space-x-2",style:{width:"100%",justifyContent:"vertical"===d?"center":"right"===u?"flex-end":"flex-start"},children:[(0,t.jsx)(a.Button,{type:"default",onClick:p,disabled:c,children:m}),(0,t.jsx)(a.Button,{onClick:g,disabled:c,loading:c,type:"danger"===y?"danger":"warning"===y?"warning":"primary",children:h})]});return(0,t.jsxs)(o.Dialog,{open:k,defaultOpen:N,onOpenChange:function(e){void 0===b||e?$(e):p()},modal:O,children:[w&&(0,t.jsx)(o.DialogTrigger,{children:w}),(0,t.jsxs)(o.DialogContent,{ref:P,hideClose:!f,...R,size:S,children:[I||n?(0,t.jsxs)(o.DialogHeader,{className:(0,r.cn)("border-b"),padding:"small",children:[I&&(0,t.jsx)(o.DialogTitle,{children:I}),n&&(0,t.jsx)(o.DialogDescription,{children:n})]}):null,e,!l&&(0,t.jsx)(o.DialogFooter,{padding:"small",children:A})]})]})}),n=(0,s.forwardRef)(({...e},s)=>(0,t.jsx)(o.DialogSection,{ref:s,...e,padding:"small",className:(0,r.cn)(e.className)})),l=(0,s.forwardRef)(({...e},s)=>(0,t.jsx)(o.DialogSectionSeparator,{ref:s,...e}));i.Content=n,i.Separator=l,e.s(["default",0,i])},40892,e=>{"use strict";var t=e.i(271332);e.s(["Modal",()=>t.default])},441345,e=>{"use strict";var t=e.i(343563);e.s(["Form",()=>t.default])},520124,e=>{"use strict";var t=e.i(460988),s=e.i(389959);e.s(["useFillTimeseriesSorted",0,e=>{let{data:r,timestampKey:a,valueKey:o,defaultValue:i,startDate:n,endDate:l,minPointsToFill:u=20,interval:d}=e;return(0,s.useMemo)(()=>{var e;if(!r[0]?.[a])return{data:r,error:null,isError:!1};try{return{data:(e=(0,t.fillTimeseries)(r,a,o,i,n,l,u,d),[...e].sort((e,t)=>new Date(e[a]).getTime()-new Date(t[a]).getTime())),error:null,isError:!1}}catch(e){return{data:[],error:e instanceof Error?e:Error(String(e)),isError:!0}}},[JSON.stringify(r),a,JSON.stringify(o),i,n,l,u,d])}])},460988,e=>{"use strict";var t=e.i(156054),s=e.i(55956),r=e.i(784820),a=e.i(605031),o=e.i(389959);e.i(128328);var i=e.i(86086),n=e.i(884892),l=e.i(857054),u=e.i(993394);let d=e=>s.default.utc(Number(e)/1e3).toISOString(),c=e=>{let t=16===String(e).length;return!Number.isNaN(Number(e))&&t},m=(e,t)=>Object.keys(e).filter(t=>e[t]).flatMap(s=>{let r=t?`${t}.${s}`:s;return"object"==typeof e[s]?m(e[s],r):[r]}),g=(e,t)=>{let s=Object.keys(t),a=u.SQL_FILTER_TEMPLATES[e],o=e=>{let s=a[e],o=(0,r.default)(t,e);if(void 0!==o&&"function"==typeof s)return s(o);if(void 0===s)if("string"==typeof o)return`${e} = '${o}'`;else return`${e} = ${o}`;return void 0===o&&"function"==typeof s?null:s&&!1===o?null:s},i=s.map(e=>{if(void 0===t[e]||"string"==typeof t[e]&&0===t[e].length)return null;if("object"==typeof t[e]){let s=m(t[e],e).map(o).filter(Boolean);return s.length>0?`(${s.join(" or ")})`:null}{let t=o(e);return null===t?null:`(${t})`}}).filter(Boolean).join(" and ");return i?"where "+i:""},p=e=>{switch(e){case"edge_logs":return`cross join unnest(metadata) as m
  ...
  cross join unnest(m.request) as request`;case"supavisor_logs":return"cross join unnest(metadata) as m";default:return""}},h=i.IS_PLATFORM?"where ( parsed.application_name = 'pg_cron' or regexp_contains(event_message, 'cron job') )":"where ( parsed.application_name = 'pg_cron' or event_message::text LIKE '%cron job%' )",f=e=>{let t=e.reduce((e,t)=>{let s=_(t);return e[s]+=1,e},{second:0,minute:0,hour:0,day:0});return Object.keys(t).reduce((e,s)=>t[e]>t[s]?e:s)},_=e=>({0:"second",1:"minute",2:"hour",3:"day"})[["second","minute","hour"].map(t=>e.get(t)).reduce((e,t)=>(0===t&&(e+=1),e),0)];function y(e){let t=e.replace(/--.*$/gm,"").replace(/\/\*[\s\S]*?\*\//gm,"");return/\b(WITH)\b(?=(?:[^']*'[^']*')*[^']*$)/i.test(t)}function b(e){let t=e.replace(/--.*$/gm,"").replace(/\/\*[\s\S]*?\*\//gm,"");return/\b(ILIKE)\b(?=(?:[^']*'[^']*')*[^']*$)/i.test(t)}function S(e){let t=e?.[0]?.request?.[0]?.sb?.[0]?.jwt?.[0]?.apikey?.[0];if(!t)return;if(t.invalid)return"<invalid>";let s=t?.payload?.[0];return s&&"HS256"===s.algorithm&&"supabase"===s.issuer&&["anon","service_role"].includes(s.role)&&!s.subject?s.role:"<unrecognized>"}function v(e){let t=e?.[0]?.request?.[0]?.sb?.[0]?.apikey?.[0]?.apikey?.[0];if(t)return t.error?`${t.prefix}... <invalid: ${t.error}>`:`${t.prefix}...`}function E(e){let t=e?.[0]?.request?.[0]?.sb?.[0]?.jwt?.[0]?.authorization?.[0];if(!t||t.invalid)return;let s=t?.payload?.[0];if(s&&s.role)return s.role}e.s(["apiKey",()=>v,"checkForILIKEClause",()=>b,"checkForWithClause",()=>y,"fillTimeseries",0,(e,t,r,a,o,i,n=20,l)=>{let u;if(0===e.length&&!(o&&i))return[];if(e.length>n)return e.map(e=>{let r=e[t],a=c(r)?d(r):s.default.utc(r).toISOString();return e[t]=a,e});if(e.length<=1&&!(o&&i))return e;let m=e.map(e=>s.default.utc(e[t])),g=i?s.default.utc(i):s.default.utc(Math.max.apply(null,m)),p=o?s.default.utc(o):s.default.utc(Math.min.apply(null,m)),h=e.length>0?m:[p,g],_=1;if(l){let e=l.match(/^(\d+)(m|h|d|s)$/);e?(_=parseInt(e[1],10),u=({s:"second",m:"minute",h:"hour",d:"day"})[e[2]]):u=f(h)}else u=f(h);0!==e.length||l||(u="minute");let y=e.map(e=>{let a=e[t],o=c(a)?d(a):s.default.utc(a).toISOString();return Array.isArray(r)&&0===r.length?{[t]:o}:(e[t]=o,e)}),b=p;for(;b.isBefore(g)||b.isSame(g);){if(!m.find(e=>e.year()===b.year()&&e.month()===b.month()&&e.date()===b.date()&&e.hour()===b.hour()&&e.minute()===b.minute()&&e.second()===b.second())){let e=("string"==typeof r?[r]:r).reduce((e,t)=>({...e,[t]:a}),{});y.push({[t]:b.toISOString(),...e})}b=b.add(_,u)}return y},"genChartQuery",0,(e,t,r)=>{let a,o,i,n,l,d,[c,m]=(a=t.iso_timestamp_end?(0,s.default)(t.iso_timestamp_end):(0,s.default)(),o=t.iso_timestamp_start?(0,s.default)(t.iso_timestamp_start):(0,s.default)(),i="minute",n=360,l=a.diff(o,"minute"),d=a.diff(o,"hour"),l>720?(i="hour",n=120):d>72&&(i="day",n=7),[o.add(-n,i),i]),f=g(e,r),_=function(e){switch(e){case"edge_logs":case"function_edge_logs":return"response.status_code >= 500";case"postgres_logs":case"pg_cron_logs":return"parsed.error_severity IN ('ERROR', 'FATAL', 'PANIC')";case"auth_logs":return"metadata.level = 'error' OR SAFE_CAST(metadata.status AS INT64) >= 400";case"function_logs":return"metadata.level IN ('error', 'fatal')";default:return"false"}}(e),y=function(e){switch(e){case"edge_logs":case"function_edge_logs":return"response.status_code >= 400 AND response.status_code < 500";case"postgres_logs":return"parsed.error_severity IN ('WARNING')";case"auth_logs":return"metadata.level = 'warning'";case"function_logs":return"metadata.level IN ('warning')";default:return"false"}}(e);e===u.LogsTableName.PG_CRON&&(e=u.LogsTableName.POSTGRES,f=h);let b=p(e);return`
SELECT
-- log-event-chart
...
ORDER BY
  timestamp ASC
  `},"genCountQuery",0,(e,t)=>{let s=g(e,t);e===u.LogsTableName.PG_CRON&&(e=u.LogsTableName.POSTGRES,s=h);let r=p(e);return`SELECT count(*) as count FROM ${e} ${r} ${s}`},"genDefaultQuery",0,(e,t,s=100)=>{let r=g(e,t),a=p(e),o="order by timestamp desc";switch(e){case"edge_logs":if(!i.IS_PLATFORM)return`
